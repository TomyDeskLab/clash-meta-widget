...
base=dict(CFBundleDevelopmentRegion='zh_CN',CFBundleExecutable='$(EXECUTABLE_NAME)',CFBundleIdentifier='$(PRODUCT_BUNDLE_IDENTIFIER)',CFBundleName='$(PRODUCT_NAME)',CFBundleShortVersionString='1.0',CFBundleVersion='7',LSMinimumSystemVersion='14.0')
